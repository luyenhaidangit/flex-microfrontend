...
import { AgentStepGeneralComponent } from './components/agent-create-wizard/steps/agent-step-general/agent-step-general.component';
import { AgentStepPublishComponent } from './components/agent-create-wizard/steps/agent-step-publish/agent-step-publish.component';
import { AgentStepPlaceholderComponent } from './components/agent-create-wizard/steps/agent-step-placeholder/agent-step-placeholder.component';

@NgModule({
  declarations: [
    AgentListComponent,
    AgentFormModalComponent,
    AgentDeleteConfirmModalComponent,
    AgentCreateWizardComponent,
    AgentStepGeneralComponent,
    AgentStepPublishComponent,
    AgentStepPlaceholderComponent
  ],
